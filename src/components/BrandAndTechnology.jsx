...
// import { FaCar, FaCogs, FaLightbulb, FaCheckCircle } from 'react-icons/fa'; // React Icons
...
//   return (
//     <PageContainer theme={theme === true ? lightTheme : darkTheme}>
//       {/* Hero Section */}
//       <HeroSection>
//         <HeroOverlay />
//         <HeroContent>
...
//           <BrandSubtitle>Innovation and Excellence in Automotive Engineering</BrandSubtitle>
//         </HeroContent>
//       </HeroSection>

//       {/* About the Brand */}
//       <Section theme={theme === false ? darkTheme : lightTheme}>
//         <SectionTitle theme={theme === false ? darkTheme : lightTheme}>About Our Brand</SectionTitle>
//         <TextContent theme={theme === false ? darkTheme : lightTheme}>
//           FAC TRADE TRACK LTD is a renowned car dealer and manufacturer committed to providing top-tier automotive
//           solutions. Our cars embody performance, reliability, and cutting-edge technology, ensuring that every
//           customer enjoys the ultimate driving experience. We focus on continuous innovation to stay at the forefront of the automotive industry.
//         </TextContent>
//       </Section>

//       {/* Technology Section */}
//       <TechnologySection theme={theme === false ? darkTheme : lightTheme}>
//         <TechnologyContent>
//           <TechnologyTitle theme={theme === false ? darkTheme : lightTheme}>Innovative Technology</TechnologyTitle>
//           <TechnologyText theme={theme === false ? darkTheme : lightTheme}>
//             At FAC TRADE TRACK LTD, we embrace the future of mobility. From electric vehicles to autonomous driving
//             technology, we invest in the latest innovations to enhance our vehicles' efficiency, safety, and performance.
//           </TechnologyText>
//           <CTAButton theme={theme === false ? darkTheme : lightTheme}>Learn More</CTAButton>
//         </TechnologyContent>
//       </TechnologySection>

//       {/* Key Features Section */}
//       <Section theme={theme === false ? darkTheme : lightTheme}>
//         <SectionTitle2 theme={theme === false ? darkTheme : lightTheme}>Our Cutting-Edge Features</SectionTitle2>
//         <FeatureList>
//           <FeatureItem theme={theme === false ? darkTheme : lightTheme}>
//             <FeatureIcon theme={theme === false ? darkTheme : lightTheme}><FaCar /></FeatureIcon>
//             <FeatureTitle theme={theme === false ? darkTheme : lightTheme}>Performance</FeatureTitle>
//             <FeatureDescription theme={theme === false ? darkTheme : lightTheme}>
//               Experience unmatched performance with our advanced engine technology and cutting-edge performance
//               systems.
//             </FeatureDescription>
//           </FeatureItem>

//           <FeatureItem theme={theme === false ? darkTheme : lightTheme}>
//             <FeatureIcon theme={theme === false ? darkTheme : lightTheme}><FaCogs /></FeatureIcon>
//             <FeatureTitle theme={theme === false ? darkTheme : lightTheme}>Precision Engineering</FeatureTitle>
//             <FeatureDescription theme={theme === false ? darkTheme : lightTheme}>
//               Every car we produce undergoes rigorous testing to ensure it meets the highest standards of quality and
//               precision.
//             </FeatureDescription>
//           </FeatureItem>

//           <FeatureItem theme={theme === false ? darkTheme : lightTheme}>
//             <FeatureIcon theme={theme === false ? darkTheme : lightTheme}><FaLightbulb /></FeatureIcon>
//             <FeatureTitle theme={theme === false ? darkTheme : lightTheme}>Sustainability</FeatureTitle>
//             <FeatureDescription theme={theme === false ? darkTheme : lightTheme}>
//               We are dedicated to sustainable development with our environmentally friendly electric vehicles and eco-friendly
