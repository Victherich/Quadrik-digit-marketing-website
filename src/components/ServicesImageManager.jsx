...
const ServicesImageManager = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `https://api.cloudinary.com/v1_1/dardewp42/image/upload`,
                {
                    method: 'POST',
                    body: formData,
                }
    ...
    const handleDelete = async (imageId) => {
        Swal.fire({
            ...
            text: `Are you sure you want to delete this image from your services gallery? This will only remove the image's entry from your database, but the image will remain on Cloudinary.`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: adminThemeColors.danger,
            cancelButtonColor: adminThemeColors.secondaryText,
