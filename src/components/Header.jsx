...
const NavItem = styled.a`
  font-size: 1rem;
  text-decoration: none;
  color: ${({ theme, isActive }) => (isActive ? (theme === 'dark' ? '#fbbf24' : 'rgba(255, 68, 0, 0.8)') : (theme === 'dark' ? '#ffffff' : '#7611D1'))};
  cursor: pointer;
    ...
    <HeaderContainer theme={theme === true ? 'light' : 'dark'}>
      ...
      <Nav isOpen={isMenuOpen} theme={theme === true ? 'light' : 'dark'} ref={sideMenuRef}>
        <NavItem 
          ...
          onClick={() => {navigate('/');window.scroll(0,0);setIsMenuOpen(false)}}
        ...
        <NavItem 
          theme={theme === true ? 'light' : 'dark'} 
          onClick={() => {navigate('/aboutus');setIsMenuOpen(false)}}
        ...
        <NavItem 
          theme={theme === true ? 'light' : 'dark'} 
          onClick={()=>{navigate("/contactus");setIsMenuOpen(false)}}
